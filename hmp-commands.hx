...
ETEXI
    ...
    {
        .name       = "trace_one",
        .args_type  = "record_name:s,start_addr:s?,end_addr:s?",
        .params     = "[record_name] [start_addr] [end_addr]",
...

    {
        ...
        .args_type  = "record_name:s",
        .params     = "[record_name]",
        .help       = "begin a code execution recording",
        .cmd = hmp_begin_code_record,
    },
    
    {
        .name       = "begin_code_records",
        .args_type  = "",
        .params     = "",
        .help       = "begin recording code executions",
        .cmd = hmp_begin_code_records,
    },
    ...
    {
        .name       = "end_code_record",
        .args_type  = "record_name:s",
        .params     = "[record_name]",
        .help       = "end recording code execution",
        .cmd = hmp_end_code_record,
    },
    
    {
        .name       = "end_all_code_records",
        .args_type  = "",
        .params     = "",
        .help       = "end all of the recording code executions",
        .cmd = hmp_end_all_code_records,
    },
    
    {
        .name       = "list_stopped_code_recordings",
        .args_type  = "",
        .params     = "",
        .help       = "list all of the stopped code recordings",
        .cmd = hmp_list_stopped_code_recordings,
    },
